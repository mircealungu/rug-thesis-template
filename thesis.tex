...
\ml{This is a comment. You can ignore it here.}
...
This is the part where you will be using a lot the {\em cite\{\}} command \cite{}
...
\section{Language Advice}

\begin{itemize}
	\item You are not Alexandre Dumas. You do not talk *to* the reader of the thesis. Sentences like: ``when you need to compile Java programs'' or ``you might ask yourself''have nothing to do with scientific writing. You report data, you do not talk to the reader. Thus: ``When a programmer needs to compile Java programs.''

	\item We are not all in this together. We do not write about 

	\item Research is a singular noun. You can not say ``there are many researches''. You can only say: ``there are many studies'', or maybe ``there are many aproaches that try to solve this and that''.
...
% We use IEEETran since it renders 
% a hyperlink for the \url field in 
% the bibliography
